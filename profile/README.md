...
| Backend | Android App | Scenario Coverage | Scenario API Perf | LLMOps | Web QA |
|---:|---:|---:|---:|---:|---:|
| **344 PASS** | **32 PASS** + OAuth/session recovery | **25/25 · 35/35** evidence reachability | P95 **241ms -> 19ms** | **10 / 0 / 0** success/failure/fallback + Redis AI quota | guidance/bookmark/mobile/final/result **PASS** |
